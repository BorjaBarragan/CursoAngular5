...
export class UserFormComponent {
  ...
  onClear(userForm: NgForm): void {
    // Sirven todos para limpiar el formulario, aunque mejor asegurarse.
    this.user = new User();
    userForm.reset();
    userForm.resetForm();
  }

  // Solamente emitimos una pulsacion, enviamos un evento sin valor.
  // Para que el padre sepa que tiene que gatillar el metodo.
  onOpenClose(): void {
